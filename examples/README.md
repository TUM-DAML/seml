# Start a Jupyter job
To start a Jupyter instance, you can use the convenience function `seml jupyter`. For using Jupyter functionality, you need to have `jupyter lab` installed in the same environment that you are using seml. To modify the default Slurm `SBATCH`
