...
def migrate_collection(db_collection_name: str, skip: bool, backup: bool):
    ...
    for migration in migrations:
        ...
        logging.warning(
            f"The collection '{db_collection_name}' needs a {migration.name()} to work with newer SEML versions.\n"
        ...
        logging.info(f'Successuflly migrated {n_updated} experiment{s_if(n_updated)}.')
