...
for exp_id in "${{exp_ids[@]}}"; do
    cmd=$(python {get_cmd_fname} --experiment_id ${{exp_id}} --database_collection {collection_str} {sources_argument} --log-verbose {log_verbose} --unobserved {unobserved} --post-mortem {post_mortem})
